...
<jsp:include page="/layout/toolbar.jsp" />
	...
	<input type="hidden" name="prodNo" value="${product.prodNo}" />
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-8" height=100px>
		      <textarea class="form-control col-sm-5" rows="5" name="prodDetail"
						 placeholder="상품정보" style="resize: none;">${product.prodDetail}</textarea>
		    </div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-8">
		      <input type="price" class="form-control" id="price" name="price" value="${product.price}" placeholder="가격">
		    </div>
		</div>
		...
		<div class="form-group">
		    ...
		    <div class="col-sm-6">
		      <input type="fileName" class="form-control" id="fileName" name="fileName" value="${product.fileName}" placeholder="서비스준비중">
		    </div>
		</div>
	...
	<div class="form-group">
		    ...
		    <div class="col-sm-2">
		 <input type="text" class="form-control" name="manuDate" id="datepicker" value="${product.manuDate}" placeholder="날짜를 선택하세요">		
		    ...
		    <label for="ssn" class="col-sm-offset-1 col-sm-1 control-label">카테고리</label>
		     <div class="col-sm-2">
		      <select class="form-control" name="cateNo" id="cate">
				...
				<option value="${cate.cateNo}"  <c:if test="${cate.cateNo eq product.cateNo }">selected</c:if>>${cate.cateName}</option>
			</c:forEach>
				</select>
		</div>
		</div>
